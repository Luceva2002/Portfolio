...
export const workExperiences = [
  ...
  },
  {
    ...
    duration: '2025 - Present',
    title: "Canva is my go-to collaborative design tool. I use it to create visually engaging content that aligns with each brand’s identity, from social media assets to business presentations.",
    icon: '/assets/canva.svg',
    animation: 'clapping',
  },
  {
    id: 3,
